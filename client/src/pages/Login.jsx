...
const Login = () => {
  ...
  <div className="bg-white p-4 m-auto shadow-custom-black border-8 border-yellow-500 w-full max-w-md rounded-3xl">
    ...
    <form onSubmit={handleLogin} className="p-6">
      <div className="mb-4">
        <label className="block text-gray-800 text-sm font-bold mb-2">User Type</label>
      ...
      <div className="mb-4">
        <input
          ...
          required
          className="block w-full rounded-lg border border-blue-500 bg-white px-3 py-3 placeholder-slate-400 shadow-sm placeholder:text-gray-500 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-700 sm:text-sm"
