      ...
      <ul className="flex justify-center mb-4 space-x-4">
        {tabTitles.map((title, index) => (
          <li
            ...
            className={`cursor-pointer py-2 px-4 font-semibold rounded-3xl transition duration-300 ${openTab === index + 1 ? 'text-white bg-blue-700' : 'text-gray-500 hover:text-black'}`}          >
            {title}
          </li>
        ))}
      </ul>
